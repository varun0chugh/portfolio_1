...
import AboutImage from "../assets/varunn_1.png";
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            <p className="text-lg mb-8">
              I am a passionate React and Python developer with a focus on building
              modern and responsive web applications. With a strong foundation
              in frontend and Currently learning backend technologies, I strive to create
